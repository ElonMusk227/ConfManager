<?php
  include 'sign_up_author_process.php' ;
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              <div class="card card-plain">
                <div class="card-header">
                  ...
                  <?php endif ?>
                  <p class="mb-0">Enter your email and verification code</p>
                </div>
                <div class="card-body">
                  <form role="form" action="" method="post">
                    ...
                    <a href="sign_in_author.php" class="text-primary text-gradient font-weight-bold">Click to join</a>
                  </p>
                  </form>
                </div>
              </div>
